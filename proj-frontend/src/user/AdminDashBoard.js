...
const AdminDashboard = () => {
        ...
        const adminRightSide = () => {
            return(
                <div className="card mb-4">
                    ...
                    <ul className='list-group'>
                        <li className='list-group-item'>
                            <span className="badge badge-success mr-2">Name:</span> Tanay Van
                        </li>
                        <li className='list-group-item'>
                            <span className="badge badge-success mr-2">Email:</span> {email}
                        </li>
                        <li className='list-group-item'>
                            <span className="badge badge-danger">Admin : The God Of the Website</span>
                        </li>
    ...
    return (
        ...
        <Base title="Welcome Admin" description='Manage all your Products Here' className='container bg-success p-4'>
            <div className='row'>
                <div className='col-3'>
                         {adminLeftSide()}
                </div>
